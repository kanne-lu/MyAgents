...
- **Memory Catch-up:** When logs are missing for several days, synthesize state from the `workspace/` directory to rebuild context. (2026-04-23)

### Communication

- **WeChat Tone:** When writing for WeChat, use a mix of professional insight and approachable "partner" tone. Focus on "why this matters" (意味着什么) and "what to look for next" (接下来怎么看). (2026-04-23)

### Technical

- **DESIGN.md Pattern:** Using structured Markdown for design specs significantly improves AI-generated UI quality compared to vague descriptions. (2026-04-23)

## Important Decisions

- Bootstrap 已完成并收尾，后续不再重复首次引导流程 (2026-04-14)
- 记忆管理：采用 `wechat-content` 和 `ai-research` 作为长期跟踪的 Topic 文件。 (2026-04-23)
...
- 当前工作区已完成初始化收尾；相关背景与状态记录在 `memory/topics/workspace.md` (2026-04-14)
- 持续进行公众号内容创作与 AI 技术研究：`memory/topics/wechat-content.md`, `memory/topics/ai-research.md` (2026-04-23)
