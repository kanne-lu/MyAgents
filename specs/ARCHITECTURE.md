...
MyAgents 是基于 Tauri v2 的桌面应用，提供 Claude Agent SDK 的图形界面。支持多 Tab 对话、IM Bot（Telegram/钉钉/社区插件）、定时任务、MCP 工具集成、多 Agent Runtime（Claude Code CLI / Codex CLI / Gemini CLI）。
...
### 9. Multi-Agent Runtime (v0.1.60 / v0.1.66)
