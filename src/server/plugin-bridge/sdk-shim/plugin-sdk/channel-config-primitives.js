...
// Source: openclaw/src/plugin-sdk/channel-config-primitives.ts

const _warned = new Set();
function _w(fn) {
  if (!_warned.has(fn)) { _warned.add(fn); console.warn('[sdk-shim] openclaw/plugin-sdk/channel-config-primitives.' + fn + '() not implemented in Bridge mode'); }
}
